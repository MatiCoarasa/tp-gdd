...
IF OBJECT_ID('CHRISTIAN_Y_LOS_MAKINSONS.VENTAS_POR_TURNO', 'V') IS NOT NULL DROP VIEW CHRISTIAN_Y_LOS_MAKINSONS.VENTAS_POR_TURNO
GO
...
CREATE VIEW CHRISTIAN_Y_LOS_MAKINSONS.VENTAS_POR_TURNO AS
SELECT
...
--SELECT * FROM TABLA123;
CREATE VIEW CHRISTIAN_Y_LOS_MAKINSONS.ENVIOS_POR_RANGO_ETARIO AS
SELECT
    T.tiempo_cuatrimestre,
    R.rango_etario,
